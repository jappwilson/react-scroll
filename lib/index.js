...
var Scroller = (function (_Component) {
  ...
  _createClass(Scroller, [{
    ...
    value: function prepareRenderProps(props) {
      ...
      var onMount = renderProps.onMount;
      var preventDefaultHorizontal = renderProps.preventDefaultHorizontal;
      var loadMask = renderProps.loadMask;
      var loading = renderProps.loading;
      var scrollbarSize = renderProps.scrollbarSize;
      var minVerticalScrollStep = renderProps.minVerticalScrollStep;
      var scrollTop = renderProps.scrollTop;
      var scrollLeft = renderProps.scrollLeft;
      var scrollHeight = renderProps.scrollHeight;
      var scrollWidth = renderProps.scrollWidth;
      var onVerticalScroll = renderProps.onVerticalScroll;
      var onHorizontalScroll = renderProps.onHorizontalScroll;
      var virtualRendering = renderProps.virtualRendering;
      var minScrollStep = renderProps.minScrollStep;
      var minHorizontalScrollStep = renderProps.minHorizontalScrollStep;

      var rest = _objectWithoutProperties(renderProps, ['onMount', 'preventDefaultHorizontal', 'loadMask', 'loading', 'scrollbarSize', 'minVerticalScrollStep', 'scrollTop', 'scrollLeft', 'scrollHeight', 'scrollWidth', 'onVerticalScroll', 'onHorizontalScroll', 'virtualRendering', 'minScrollStep', 'minHorizontalScrollStep']);
